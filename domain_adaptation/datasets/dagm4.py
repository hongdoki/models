"""Provides data for the DAGM 2007 dataset 4.
"""
...
_FILE_PATTERN = 'target_d4_%s.tfrecords'

_SPLITS_TO_SIZES = {'train': 4559, 'val': 506, 'test': 5095}

_NUM_CLASSES = 2

_ITEMS_TO_DESCRIPTIONS = {
    'image': 'A [256 x 256] gray-scale image.',
